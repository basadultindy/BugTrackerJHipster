...
@RestController
@RequestMapping("/api/bug-tracker-j-hipster-kafka")
public class BugTrackerJHipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BugTrackerJHipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BugTrackerJHipsterKafkaResource(KafkaProperties kafkaProperties) {
