...
import com.mycompany.bugtracker.repository.search.TicketSearchRepository;
...
public class TicketResourceIT {
    ...
    /**
     * This repository is mocked in the com.mycompany.bugtracker.repository.search test package.
     *
     * @see com.mycompany.bugtracker.repository.search.TicketSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final TicketResource ticketResource = new TicketResource(ticketRepository, mockTicketSearchRepository);
    ...
    public void getAllTicketsWithEagerRelationshipsIsEnabled() throws Exception {
        TicketResource ticketResource = new TicketResource(ticketRepositoryMock, mockTicketSearchRepository);
    ...
    public void searchTicket() throws Exception {
        // Initialize the database
        ticketRepository.saveAndFlush(ticket);
        when(mockTicketSearchRepository.search(queryStringQuery("id:" + ticket.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(ticket), PageRequest.of(0, 1), 1));
        // Search the ticket
